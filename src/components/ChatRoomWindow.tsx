    ...
    <div className="absolute inset-0 bg-slate-50 flex flex-col z-40" id={`chat-room-${chat.id}`}>
      ...
      <div className="bg-[#0B1220] text-white pt-4 pb-3.5 px-4 flex items-center gap-3 shadow-md border-b border-[#18233C] shrink-0">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <div className="w-9 h-9 bg-[#2563EB]/25 text-[#60A5FA] border border-[#2563EB]/30 rounded-full flex items-center justify-center font-extrabold text-xs uppercase relative">
      ...
      <div className="bg-white border-b border-slate-100 p-2.5 flex items-center gap-2.5 shadow-xs shrink-0">
        <img 
          ...
          className="w-10 h-10 object-contain p-0.5 bg-slate-900 rounded-lg border border-slate-100 shrink-0" 
          onError={(e) => {
                  ...
                  {msg.imageUrl && (
                    ...
                    >
                      <img 
                        ...
                        loading="lazy" 
                        decoding="async" 
                        className="w-full max-h-56 object-contain bg-slate-900 rounded-xl hover:opacity-95 transition-opacity p-0.5" 
                        onError={(e) => {
                          (e.currentTarget as HTMLImageElement).src = "https://images.unsplash.com/photo-1517524008697-84bbe3c3fd98?w=300&auto=format&fit=crop&q=60";
                        }}
                      />
