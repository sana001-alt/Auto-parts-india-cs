    ...
    >
      ...
      >
        ...
        <div className="mt-6 pt-5 border-t border-slate-700/50 grid grid-cols-2 gap-3">
          <div className="flex flex-col justify-between p-3.5 rounded-2xl bg-slate-800/40 backdrop-blur-md border border-slate-700/50 shadow-md shadow-black/20">
            <div className="w-10 h-10 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center mb-2.5">
              <ShieldCheck size={32} className="text-emerald-400 drop-shadow-[0_0_8px_rgba(52,211,153,0.35)] shrink-0" />
            </div>
            <div>
          ...
          <div className="flex flex-col justify-between p-3.5 rounded-2xl bg-slate-800/40 backdrop-blur-md border border-slate-700/50 shadow-md shadow-black/20">
            <div className="w-10 h-10 rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center mb-2.5">
              <MessageSquare size={32} className="text-blue-400 drop-shadow-[0_0_8px_rgba(96,165,250,0.35)] shrink-0" />
            </div>
            <div>
